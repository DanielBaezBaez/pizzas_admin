...
require_once("include/tipo_items_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "united";
		$layout->customCssPageName = "tipo_items_detailspreview";
...
$page_layouts["tipo_items_detailspreview"] = $layout;
...
$xt->load_template(GetTemplateName("tipo_items", "detailspreview"));
