...
$layout->version = 3;
	$layout->bootstrapTheme = "united";
		$layout->customCssPageName = "detalles_pedidos_list";
...
$page_layouts["detalles_pedidos_list"] = $layout;
...
$page_layouts["empresas_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "united";
		$layout->customCssPageName = "items_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["items_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "united";
		$layout->customCssPageName = "pedidos_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["pedidos_masterlist"] = $layout;
