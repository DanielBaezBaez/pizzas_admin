...
require_once("include/estados_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "united";
		$layout->customCssPageName = "estados_detailspreview";
...
$page_layouts["estados_detailspreview"] = $layout;
...
$xt->load_template(GetTemplateName("estados", "detailspreview"));
