...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "barrios" ] = array( "url" => "barrios", "type" => 0 );
	$projectEntitiesReverse[ "barrios" ] = "barrios";
	$projectEntities[ "ciudades" ] = array( "url" => "ciudades", "type" => 0 );
	$projectEntitiesReverse[ "ciudades" ] = "ciudades";
	$projectEntities[ "clientes" ] = array( "url" => "clientes", "type" => 0 );
	$projectEntitiesReverse[ "clientes" ] = "clientes";
	$projectEntities[ "detalles_facturas" ] = array( "url" => "detalles_facturas", "type" => 0 );
	$projectEntitiesReverse[ "detalles_facturas" ] = "detalles_facturas";
	$projectEntities[ "detalles_pedidos" ] = array( "url" => "detalles_pedidos", "type" => 0 );
	$projectEntitiesReverse[ "detalles_pedidos" ] = "detalles_pedidos";
	$projectEntities[ "empresas" ] = array( "url" => "empresas", "type" => 0 );
	$projectEntitiesReverse[ "empresas" ] = "empresas";
	$projectEntities[ "estados" ] = array( "url" => "estados", "type" => 0 );
	$projectEntitiesReverse[ "estados" ] = "estados";
	...
	$projectEntities[ "menus" ] = array( "url" => "menus", "type" => 0 );
	$projectEntitiesReverse[ "menus" ] = "menus";
	$projectEntities[ "paises" ] = array( "url" => "paises", "type" => 0 );
	$projectEntitiesReverse[ "paises" ] = "paises";
	$projectEntities[ "pedidos" ] = array( "url" => "pedidos", "type" => 0 );
	$projectEntitiesReverse[ "pedidos" ] = "pedidos";
	$projectEntities[ "personales" ] = array( "url" => "personales", "type" => 0 );
	$projectEntitiesReverse[ "personales" ] = "personales";
	$projectEntities[ "personas" ] = array( "url" => "personas", "type" => 0 );
	$projectEntitiesReverse[ "personas" ] = "personas";
	$projectEntities[ "preparaciones" ] = array( "url" => "preparaciones", "type" => 0 );
	$projectEntitiesReverse[ "preparaciones" ] = "preparaciones";
	$projectEntities[ "promociones" ] = array( "url" => "promociones", "type" => 0 );
	$projectEntitiesReverse[ "promociones" ] = "promociones";
	$projectEntities[ "proveedores" ] = array( "url" => "proveedores", "type" => 0 );
	$projectEntitiesReverse[ "proveedores" ] = "proveedores";
	$projectEntities[ "sucursales" ] = array( "url" => "sucursales", "type" => 0 );
	$projectEntitiesReverse[ "sucursales" ] = "sucursales";
	$projectEntities[ "tipo_items" ] = array( "url" => "tipo_items", "type" => 0 );
	$projectEntitiesReverse[ "tipo_items" ] = "tipo_items";
	$projectEntities[ "tipo_personales" ] = array( "url" => "tipo_personales", "type" => 0 );
	$projectEntitiesReverse[ "tipo_personales" ] = "tipo_personales";
