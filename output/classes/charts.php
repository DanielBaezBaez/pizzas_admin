...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("barrios" == $this->chrt_array['tables'][0])
			return true;
		if("ciudades" == $this->chrt_array['tables'][0])
			return true;
		if("clientes" == $this->chrt_array['tables'][0])
			return true;
		if("detalles_facturas" == $this->chrt_array['tables'][0])
			return true;
		if("detalles_pedidos" == $this->chrt_array['tables'][0])
			return true;
		if("empresas" == $this->chrt_array['tables'][0])
			return true;
		if("estados" == $this->chrt_array['tables'][0])
			return true;
		...
		if("menus" == $this->chrt_array['tables'][0])
			return true;
		if("paises" == $this->chrt_array['tables'][0])
			return true;
		if("pedidos" == $this->chrt_array['tables'][0])
			return true;
		if("personales" == $this->chrt_array['tables'][0])
			return true;
		if("personas" == $this->chrt_array['tables'][0])
			return true;
		if("preparaciones" == $this->chrt_array['tables'][0])
			return true;
		if("promociones" == $this->chrt_array['tables'][0])
			return true;
		if("proveedores" == $this->chrt_array['tables'][0])
			return true;
		if("sucursales" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_items" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_personales" == $this->chrt_array['tables'][0])
			return true;
