...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "pizzas_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "barrios", "varname" => "pizzas_at_localhost__barrios", "altvarname" => "barrios", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "ciudades", "varname" => "pizzas_at_localhost__ciudades", "altvarname" => "ciudades", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "clientes", "varname" => "pizzas_at_localhost__clientes", "altvarname" => "clientes", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "detalles_facturas", "varname" => "pizzas_at_localhost__detalles_facturas", "altvarname" => "detalles_facturas", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "detalles_pedidos", "varname" => "pizzas_at_localhost__detalles_pedidos", "altvarname" => "detalles_pedidos", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "empresas", "varname" => "pizzas_at_localhost__empresas", "altvarname" => "empresas", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "estados", "varname" => "pizzas_at_localhost__estados", "altvarname" => "estados", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "facturas", "varname" => "pizzas_at_localhost__facturas", "altvarname" => "facturas", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "failed_jobs", "varname" => "pizzas_at_localhost__failed_jobs", "altvarname" => "failed_jobs", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "insumos", "varname" => "pizzas_at_localhost__insumos", "altvarname" => "insumos", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "items", "varname" => "pizzas_at_localhost__items", "altvarname" => "items", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "menus", "varname" => "pizzas_at_localhost__menus", "altvarname" => "menus", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "migrations", "varname" => "pizzas_at_localhost__migrations", "altvarname" => "migrations", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "paises", "varname" => "pizzas_at_localhost__paises", "altvarname" => "paises", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "password_resets", "varname" => "pizzas_at_localhost__password_resets", "altvarname" => "password_resets", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "pedidos", "varname" => "pizzas_at_localhost__pedidos", "altvarname" => "pedidos", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "personal_access_tokens", "varname" => "pizzas_at_localhost__personal_access_tokens", "altvarname" => "personal_access_tokens", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "personales", "varname" => "pizzas_at_localhost__personales", "altvarname" => "personales", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "personas", "varname" => "pizzas_at_localhost__personas", "altvarname" => "personas", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "pizzas_admin_settings", "varname" => "pizzas_at_localhost__pizzas_admin_settings", "altvarname" => "pizzas_admin_settings", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "preparaciones", "varname" => "pizzas_at_localhost__preparaciones", "altvarname" => "preparaciones", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "promociones", "varname" => "pizzas_at_localhost__promociones", "altvarname" => "promociones", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "proveedores", "varname" => "pizzas_at_localhost__proveedores", "altvarname" => "proveedores", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "sucursales", "varname" => "pizzas_at_localhost__sucursales", "altvarname" => "sucursales", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "tipo_items", "varname" => "pizzas_at_localhost__tipo_items", "altvarname" => "tipo_items", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "tipo_personales", "varname" => "pizzas_at_localhost__tipo_personales", "altvarname" => "tipo_personales", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "pizzas_at_localhost__users", "altvarname" => "users", "connId" => "pizzas_at_localhost", "schema" => "", "connName" => "pizzas at localhost");
		}
	}
