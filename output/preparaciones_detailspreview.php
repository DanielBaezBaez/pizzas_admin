...
require_once("include/preparaciones_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "united";
		$layout->customCssPageName = "preparaciones_detailspreview";
...
$page_layouts["preparaciones_detailspreview"] = $layout;
...
$xt->load_template(GetTemplateName("preparaciones", "detailspreview"));
