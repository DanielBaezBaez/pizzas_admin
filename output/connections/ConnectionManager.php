...
class ConnectionManager
{
	...
	{
		return $this->byId( "pizzas_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "pizzas_at_localhost";
		$data["connName"] = "pizzas at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;mysqlbeta;;pizzas;;1"; //currently unused

		$this->_connectionsIdByName["pizzas at localhost"] = "pizzas_at_localhost";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "root";
		$data["ODBCPWD"] = "mysqlbeta";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][2] = "mysqlbeta";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "pizzas";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=mysqlbeta;Database=pizzas;OPTION=3";
		// encription set
		...
		$connectionsData["pizzas_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["barrios"] = "pizzas_at_localhost";
		$connectionsIds["ciudades"] = "pizzas_at_localhost";
		$connectionsIds["clientes"] = "pizzas_at_localhost";
		$connectionsIds["detalles_facturas"] = "pizzas_at_localhost";
		$connectionsIds["detalles_pedidos"] = "pizzas_at_localhost";
		$connectionsIds["empresas"] = "pizzas_at_localhost";
		$connectionsIds["estados"] = "pizzas_at_localhost";
		$connectionsIds["facturas"] = "pizzas_at_localhost";
		$connectionsIds["insumos"] = "pizzas_at_localhost";
		$connectionsIds["items"] = "pizzas_at_localhost";
		$connectionsIds["menus"] = "pizzas_at_localhost";
		$connectionsIds["paises"] = "pizzas_at_localhost";
		$connectionsIds["pedidos"] = "pizzas_at_localhost";
		$connectionsIds["personales"] = "pizzas_at_localhost";
		$connectionsIds["personas"] = "pizzas_at_localhost";
		$connectionsIds["preparaciones"] = "pizzas_at_localhost";
		$connectionsIds["promociones"] = "pizzas_at_localhost";
		$connectionsIds["proveedores"] = "pizzas_at_localhost";
		$connectionsIds["sucursales"] = "pizzas_at_localhost";
		$connectionsIds["tipo_items"] = "pizzas_at_localhost";
		$connectionsIds["tipo_personales"] = "pizzas_at_localhost";
		$connectionsIds["users"] = "pizzas_at_localhost";
